...
4. **Fix root causes, not symptoms.** Never weaken a measurement to get green: no deleted or skipped
...
5. **Correct the record.** If a checkpoint was over-claimed, downgrade it with `conductor task` rather
   than leaving a false DONE standing.
6. **Close** as any session does: evidence artifact, claim what is genuinely done with
