...
last: s6 CLAIMED all of PK3 - PK3.1 (0d43747, evidence .conductor/evidence/PK3/pk3.1.md, rig 23/23, real send 3820 deleted), PK3.2 (965a6dd, pk3.2.md, rig 20/20, real send 3821 deleted), PK3.3 (9f63a5f, pk3.3.md, rig 12/12). Bugs #76 and #98 closed. Guard runs green: scoped 303/303, run-loop/harness/report 216/216, docs 83/83.
  ...
  PK2 (still true): real 'Conductor Courier' ARMED 2026-09-17T11:37:30Z. PK6.1 READING: `tools/peyk/pk2-3-arm-real-courier.ps1 -ReadOnly`, then courier.log after 11:37:30Z; the FIRST death record (pid 7988, 11:37:31Z) is the installer's /End. Bug #93 stays OPEN for PK6.1. The armed courier speaks protocol 2, so a fresh-build run refuses it as stale and sends directly until the owner's reinstall.
