...
last: s4 PK2.1 CLAIMED (4affb95, rig tools/peyk/pk2-1-live-proof.ps1 18/18, evidence f1c1a31). PK2.2 IN PROGRESS: code be76d1f + rig 7e05c72 committed; live rig tools/peyk/pk2-2-live-proof.ps1 was launched under conductor bg writing .conductor/evidence/PK2/pk2.2-live-proof.log (~15 min). If that log is complete and all PASS but PK2.2 is unclaimed, force-add it and claim; if absent, rerun the rig (it builds, uses scratch tasks pk22-keepalive-*/pk22-nokeepalive-* and deletes them).
