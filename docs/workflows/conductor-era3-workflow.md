...
2. Produce evidence artifact under `docs/era3/evidence/<session>/`.
...
**Evidence:** `docs/era3/evidence/D1/status-output.txt` + gate output
...
**Evidence:** `docs/era3/evidence/D2/gate-output.txt`
...
**Evidence:** `docs/era3/evidence/D3/heartbeat-toggle.txt`
...
**Evidence:** `docs/era3/evidence/D4/control-feedback.txt`
...
**Evidence:** `docs/era3/evidence/O1/structured-log.txt`
...
**Evidence:** `docs/era3/evidence/O2/budget-intelligence.txt`
...
**Evidence:** `docs/era3/evidence/O3/cost-split.txt`
