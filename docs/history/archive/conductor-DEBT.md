...
**Read order:** this file → `CONDUCTOR-START.md` handoff → `docs/history/workflows/conductor-post-b12-workflow.md`.
...
**Note:** This is already planned as B6.3 in `docs/history/baton/stages/B6.md`. This entry provides context from the live observations.
...
- `docs/history/baton/stages/B6.md` (update B6.3 design)
...
**Checkpoint:** per B6.3 plan in `docs/history/baton/stages/B6.md`
...
- `docs/history/baton/evidence/B0.4-gate.txt` (update)
