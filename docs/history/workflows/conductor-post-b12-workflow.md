...
2. Produce evidence artifact under `docs/history/baton/evidence/<session>/`.
...
| 8 | **Final handover** | 8a. Write `docs/history/qa-reports/CONDUCTOR-FINAL.md`: full feature table with rates, bugs fixed, remaining findings. 8b. Generate **Needs Human Verification checklist**: items agent couldn't test (Telegram with real token, visual TUI, credential-gated tests). 8c. Update TRACKER.md final handoff. 8d. Commit. | ~30 min |
