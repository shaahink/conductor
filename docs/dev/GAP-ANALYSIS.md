...
archive historical trackers to `docs/history/archive/trackers/`; scrub foreign-project refs + evidence
...
- Known-gap ledgers: `docs/operating.md` §7, `docs/history/CONDUCTOR-UX.md` appendix,
...
- Deferred design intent: `.conductor/handovers/F1.md:49` (FU-F1-03),
  `CONDUCTOR-VNEXT-PLAN.md:95` (F7.1), `docs/history/CONDUCTOR-PLANNER.md:48-49,120`,
  `docs/dev/NEXT-FEATURES.md:77-80`.
