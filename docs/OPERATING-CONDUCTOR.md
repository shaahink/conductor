...
Companion docs: `README.md` (what it is), `docs/DOGFOOD-RUNBOOK.md` (diagnose a stuck/dead run),
`docs/maestro/M9-FINAL-AUDIT.md` (what conforms/deviates), `AGENTS.md` (session handover).
...
**It died / looks stuck.** Follow `docs/DOGFOOD-RUNBOOK.md`'s procedure: is a `conductor.exe`
...
caching, and NEEDS-HUMAN escalation. Full detail: `docs/maestro/M9-FINAL-AUDIT.md` §M9.1.
