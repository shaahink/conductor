...
$planJson = @"
{
  ...
  "repo": "$repo",
  "tracker": "TRACKER.md",
  "planDoc": "docs/history/workflows/$safeName-workflow.md",
...
$gatesStr
  ...
  "promptExtra": "Generated by paste-plan.ps1. See docs/history/workflows/$safeName-workflow.md for session details."
}
"@
